...
export default async function ProductDetails({ 
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <Link href="/Headphones"><button className="p-3 mx-20 text-[15px] text-black 2xl:w-[35%]">Go Back</button></Link>
      ...
      <div className="flex flex-col w-full">
        <div className="flex mt-15 gap-30 items-center justify-center max-w-[80%] m-auto 2xl:w-[60%]">
